...
\href{https://github.com/awslabs/aws-sdk-rust}{\textbf{AWS}}, Melrose, MA (Remote) \hfill{Senior Software Engineer, July 2020 | Present}
 \begin{outerlist}
    \item[] \begin{innerlist}[-]
        \item Lead the team supporting Rust adoption across Amazon. Distill great ideas from across
        the company into core primitives that become de facto solutions.
        \item Created \href{https://github.com/awslabs/metrique}{metrique}, a metrics library that
        replaced effectively all hand-written metrics libraries at Amazon.
        \item Created \href{https://github.com/dial9-rs/dial9}{dial9}, a flight recorder and profiler
        used in production at Amazon, Cloudflare, OpenAI, and many others.
        \item Founded and led the team behind the \href{https://github.com/awslabs/aws-sdk-rust}{AWS SDK for Rust}
        and \href{https://github.com/awslabs/smithy-rs}{smithy-rs}, its underlying code generator.
    \end{innerlist}
\end{outerlist}
