...
\\
285 Washington Street\: & \href{mailto:rcoh@rcoh.me}{rcoh@rcoh.me} \\
Melrose, MA 02176\: 
\end{tabular}
%\end{center}
...
\href{https://github.com/awslabs/aws-sdk-rust}{\textbf{AWS}}, Melrose, MA (Remote) \hfill{Senior Software Engineer, July 2020 | Present}
 \begin{outerlist}
    \item[] \begin{innerlist}[-]
        \item Design and build \href{https://github.com/awslabs/smithy-rs}{smithy-rs}, a client and server code generator for 
        the \href{https://smithy.io}{Smithy IDL}. \href{https://github.com/awslabs/smithy-rs}{smithy-rs} generates clients for 
        the AWS SDK, dozens of internal AWS services, and several external customers.
        \item Found and lead team to build \href{https://github/awslabs/aws-sdk-rust}{AWS SDK for Rust}.
	\item[] \begin{innerlist}[+]
                \item Work with Rust language and SDK stakeholders to design an SDK balancing ease-of-use, flexibility and performance.
                The Rust SDK is among the fastest AWS SDK with overhead of 20-30$\mu$s per request.
                \item Build wire-level traffic record-and-replay framework for deterministic testing and fault simulation.
                \item Implement high-performance parser and serializer generators for XML and JSON.
        \end{innerlist}
        \item Lead organization-wide initiative to code generate endoint resolution across all SDKs. 
        This reduces custom code and implementation time while eliminating a class of common SDK bugs.
    \end{innerlist}
\end{outerlist}
