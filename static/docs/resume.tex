...
\textbf{AWS} \hfill{Senior Software Engineer, July 2020 | Present}
 \begin{outerlist}
    \item[] \textit{Rust Platform Team} \hfill{2024 | Present}
    \begin{innerlist}[-]
        ...
        metrics library used by over 500 services. It replaced effectively all hand-written metrics
        libraries at Amazon.
    ...
    \item[] \textit{AWS SDK for Rust} \hfill{2020 | 2024}
    \begin{innerlist}[-]
        ...
        the Rust SDK and over 1,000 services at Amazon and beyond.
    \end{innerlist}
\end{outerlist}
