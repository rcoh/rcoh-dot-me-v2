...
\\
735 Roosevelt Ave\: & \href{mailto:russell.r.cohen@gmail.com}{russell.r.cohen@gmail.com} \\
...
\href{http://rcoh.me}{\textbf{Self Employed}}, Redwood City, CA \hfill{Freelance Software Engineer, February 2016 | Present}
 \begin{outerlist}
    \item[] \begin{innerlist}[-]
        \item Join startups and add velocity to help finish key projects
        \item Recent Projects:
        \item[] \begin{innerlist}[+]
        		\item Setup Devops / CI Pipeline (Terraform, Jenkins, Ansible, Nginx, SSL, etc.)
        		\item Improve system architecture / cleanup tech-debt
        		\item General feature work (Scala, Python, ReactJS / Redux, Spark)
		\item Implement DSL and DSL to Spark compiler
	\end{innerlist}
    \end{innerlist}
\end{outerlist}
...
\section{Skills}
Scala, Java, Python, Go, Node.js / ES6 / React, (my/Postge)SQL, MongoDB, Cassandra, Elasticsearch


\section{Interests}
rock climbing, paragliding, backpacking, ultimate, cello
